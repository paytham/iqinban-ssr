  ...
  <main class="i-about">
    ...
    <section class="i-section i-about__section2">
      <div class="i-about__section2-text">
        ...
        <h1 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="300ms">错漏快慢，一目了然</h1>
        <i-row class="i-about__section2-container hasmargrin">
          <i-col :span="3" v-for="i in 4" :key="i">
            <div class="i-about__section2-item">
              ...
              <p class="p1 wow fadeInUp" data-wow-duration="2s" data-wow-delay="500ms">首席运营官--王先生</p>
            </div>
          </i-col>
        </i-row>
        <h1 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="250ms">错漏快慢，一目了然</h1>
        <div class="i-about__section2-container">
          <div class="i-about__section2-contact">
            <div class="i-about__section2-chr">
              <p class="p1 wow fadeInUp" data-wow-duration="2s" data-wow-delay="300ms">地址</p>
              <p class="p1 wow fadeInUp" data-wow-duration="2s" data-wow-delay="350ms">智能纠错系统采用基于机器学习的音频和图像</p>
            </div>
            <div class="i-about__section2-chr">
              <p class="p1 wow fadeInUp" data-wow-duration="2s" data-wow-delay="400ms">邮箱</p>
              <p class="p1 wow fadeInUp" data-wow-duration="2s" data-wow-delay="450ms">caiyuhao2015@gmail.com</p>
            </div>
            <div class="i-about__section2-chr">
              <p class="p1 wow fadeInUp" data-wow-duration="2s" data-wow-delay="500ms">电话</p>
              <p class="p1 wow fadeInUp" data-wow-duration="2s" data-wow-delay="550ms">110-1234-5678</p>
            </div>
            <div class="i-about__section2-chr is-last">
              <p class="p1 wow fadeInUp" data-wow-duration="2s" data-wow-delay="600ms">联系人</p>
              <p class="p1 wow fadeInUp" data-wow-duration="2s" data-wow-delay="650ms">蔡先生</p>
            </div>
          </div>
